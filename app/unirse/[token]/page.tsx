      ...
      <div className="w-full max-w-md space-y-6">
        ...
        {!authReady ? (
          ...
          <div className="glass-card rounded-2xl p-6 space-y-4">
            ...
            <form onSubmit={handleAuth} className="space-y-3">
              ...
              <div className="relative">
                <input
                  ...
                  required
                  className="w-full px-4 py-3 pr-11 rounded-xl border-2 border-mundial-purple/20 bg-white/70 text-mundial-purple placeholder:text-mundial-purple/30 focus:outline-none focus:border-mundial-purple/50 transition-colors"
                />
                <button
                  type="button"
            ...
            <button
              onClick={() => { setAuthMode((m) => m === 'login' ? 'register' : 'login'); setAuthError(null); setConfirm(''); setShowPassword(false); setShowConfirm(false) }}
