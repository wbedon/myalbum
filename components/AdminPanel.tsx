    ...
    <div className="space-y-8">
      ...
      {loading ? (
        <div className="grid gap-3">
          {[1, 2].map((i) => (
            <div key={i} className="h-24 rounded-2xl bg-mundial-cream animate-pulse" />
          ))}
        </div>
      ) : albums.length === 0 ? (
        <div className="text-center py-20 bg-white rounded-2xl border-2 border-dashed border-mundial-purple/15 space-y-3">
          ...
          <p className="text-sm text-mundial-purple/40">
            Creá el primer álbum con el botón de arriba.
          </p>
        </div>
      ) : (
        <div className="grid gap-3">
          {albums.map((album) => (
            ...
            >
              {/* Ícono */}
              <div className="w-12 h-12 rounded-xl bg-mundial-yellow/20 flex items-center justify-center shrink-0">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-mundial-purple/40 mt-1">
                  Creado el {formatDate(album.created_at)}
                </p>
              </div>
